                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form wire:submit.prevent="login" class="space-y-4 md:space-y-6" >
                            ...
                            <div class="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                                ...
                                <div>
                                  <span class="font-medium">Woops!</span> {{ $errorMessage }}
                                </div>
                              </div>
                            @endif
                            {{-- @php
                                // Dump de todos los datos de la sesión
                                dump(session()->all());
                            @endphp --}}
                            <div>
                                <label for="email"
                            ...
                            <div>
                                ...
                                <input type="password" wire:model="password" name="password" id="password" placeholder="••••••••"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required="">
                            </div>
