    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <!-- Ocultar 'Login' si estás en la página de login o si ya has iniciado sesión -->
                @if (!Route::is('login') && !session()->has('auth_token'))
                    <a href="{{ route('login') }}"
                ...
                <!-- Ocultar 'Registro' si estás en la página de registro o si ya has iniciado sesión -->
                @if (!Route::is('register') && !session()->has('auth_token'))
                ...
                <!-- Si el usuario está autenticado (hay token en la sesión), mostrar el enlace de Logout y ocultar Login/Register -->
